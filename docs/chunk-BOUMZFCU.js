import{a as B,b as P,d as V,e as H,f as S,g as O}from"./chunk-F7AFMGPY.js";import{K as A,S as y,U as E,V as j,W as M,Y as $,ea as N,fa as R}from"./chunk-ASSW3MXM.js";import{$a as _,Bb as D,Cb as L,Cc as T,Jb as v,Ma as I,Na as s,P as f,Pb as x,Q as d,V as c,Wa as b,Xa as m,Ya as k,_a as g,ca as p,dc as z,ib as C,kb as h,sb as o,tb as a,zb as r}from"./chunk-LTD3MHGW.js";import"./chunk-NUMHA4AJ.js";var Z=({dt:e})=>`
.p-inputtext {
    font-family: inherit;
...
`,ne={root:({instance:e,props:l})=>["p-floatlabel",{"p-floatlabel-over":l.variant==="over","p-floatlabel-on":l.variant==="on","p-floatlabel-in":l.variant==="in"}]},X=(()=>{class e extends M{name="floatlabel";theme=ie;classes=ne;static \u0275fac=(()=>{let n;return function(t){return(n||(n=p(e)))(t||e)}})();static \u0275prov=f({token:e,factory:e.\u0275fac})}return e})();var le=["*"],F=(()=>{class e extends ${_componentStyle=c(X);variant="over";static \u0275fac=(()=>{let n;return function(t){return(n||(n=p(e)))(t||e)}})();static \u0275cmp=b({type:e,selectors:[["p-floatlabel"],["p-floatLabel"],["p-float-label"]],hostVars:8,hostBindings:function(i,t){i&2&&h("p-floatlabel",!0)("p-floatlabel-over",t.variant==="over")("p-floatlabel-on",t.variant==="on")("p-floatlabel-in",t.variant==="in")},inputs:{variant:"variant"},features:[x([X]),g],ngContentSelectors:le,decls:1,vars:0,template:function(i,t){i&1&&(D(),L(0))},dependencies:[T,y],encapsulation:2,changeDetection:0})}return e})(),q=(()=>{class e{static \u0275fac=function(i){return new(i||e)};static \u0275mod=m({type:e});static \u0275inj=d({imports:[F,y,y]})}return e})();var w=class e{constructor(l,n){this.authService=l;this.messageService=n}credentials={identifier:"",password:""};APP_PASSWORD_REGEX=new RegExp("[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}");onLogin(){this.credentials.identifier.trim().length&&this.APP_PASSWORD_REGEX.exec(this.credentials.password)?this.authService.login(this.credentials):this.messageService.warnIcon("Please check your credentials.","Oops!")}static \u0275fac=function(n){return new(n||e)(s(j),s(E))};static \u0275cmp=b({type:e,selectors:[["app-login"]],decls:13,vars:2,consts:[[1,"flex","h-full","items-center","justify-center"],["header","Login"],[1,"flex","flex-col","mt-8"],["pInputText","","name","handle",3,"ngModelChange","keyup.enter","ngModel"],[1,"mt-8"],["pInputText","","name","password",3,"ngModelChange","keyup.enter","ngModel"],[1,"mt-6",3,"onClick"]],template:function(n,i){n&1&&(o(0,"div",0)(1,"p-card",1)(2,"p",2)(3,"p-floatlabel")(4,"input",3),r("ngModelChange",function(u){return i.credentials.identifier=u})("keyup.enter",function(){return i.onLogin()}),a(),o(5,"label"),v(6,"Handle"),a()(),o(7,"p-floatlabel",4)(8,"input",5),r("ngModelChange",function(u){return i.credentials.password=u})("keyup.enter",function(){return i.onLogin()}),a(),o(9,"label"),v(10,"App Password"),a()(),o(11,"p-button",6),r("onClick",function(){return i.onLogin()}),v(12," Login "),a()()()()),n&2&&(I(4),C("ngModel",i.credentials.identifier),I(4),C("ngModel",i.credentials.password))},dependencies:[O,V,H,S,P,B,W,G,q,F,R,N],encapsulation:2})};var Ne=[{path:"",component:w}];export{Ne as routes};
